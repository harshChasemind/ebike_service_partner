import 'package:doctorappointment/doctor_pages/doctor_authentication/doctor_add_new_patient.dart';
...
import 'package:doctorappointment/doctor_pages/doctor_profile/report_details.dart';
...
class _DoctorPatientsState extends State<DoctorPatients> {
  ...
  List name = ["Samaresh Srivastav","Vaishali Vasavada","Shail Vasavada","Deepa Agrawal","Harsha Tripathi"];
  List profession = ["Ophthalmology","Anaesthesiology","Ophthalmology","Anaesthesiology","Ophthalmology"];
  List rating = ["5","4.9","4.7","5","4.9"];
  List review = ["1,872 Reviews","127 Reviews","5,223 Reviews","405 Reviews","523 Reviews"];
  List img = [
    DoctorPngimage.d1,
    DoctorPngimage.d2,
    DoctorPngimage.d3,
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Paitents".tr,style: isemibold.copyWith(fontSize: 20,color: themedata.isdark?DoctorColor.white:DoctorColor.black),),
          actions: [
            Padding(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context) {
                      return const DoctorAddNewPatient();
                    },
                  ));
                },
                  child: Icon(Icons.add, size: 30,))/*Image.asset(
                DoctorPngimage.add,
                height: height / 46,
