...
class DoctorReports extends StatefulWidget {
  const DoctorReports({Key? key}) : super(key: key);
...
class _DoctorReportsState extends State<DoctorReports> {
  ...
  List arrNames = ["Rajat Sharma","Vaishali Vasavada","Shail Vasavada","Deepa Agrawal","Harsha Tripathi"];
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Reports".tr,style: isemibold.copyWith(fontSize: 20,color: themedata.isdark?DoctorColor.white:DoctorColor.black),),
          /*bottom: TabBar(
