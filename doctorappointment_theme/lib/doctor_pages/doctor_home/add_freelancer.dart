...
class AddFreeancerAccount extends StatefulWidget {
  const AddFreeancerAccount({Key? key}) : super(key: key);

  @override
  State<AddFreeancerAccount> createState() => _AddFreeancerAccountState();
}

class _AddFreeancerAccountState extends State<AddFreeancerAccount> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  final themedata = Get.put(DoctorThemecontroler());
  final controller = Get.put(DoctorAddFreelancerController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Add Freelancer Account" , style: isemibold.copyWith(fontSize: 16),),
      ),
...
class DoctorAddFreelancerController extends GetxController {
